...
{ 
	$str = '<div align="center" id="wpmem_msg">
		...
		<p style="color: #222222;">' . __('You entered an invalid username or password.', 'wp-members') . '</p>				<p style="color: #222222;">Use the <strong>Sign in</strong> button found at the top right of this screen.</p>
...
function wpmem_inc_registration_NEW( $toggle = 'new', $heading = '' )
{
	...
	if( !$heading ) { $heading = apply_filters( 'wpmem_register_heading', __( 'Sign Up Form', 'wp-members' ) ); }
	...
	$form = $form . '<input name="redirect_to" type="hidden" value="' . get_permalink() . '" />
		<div class="button_div">						<p><strong>Note:</strong> A validation password will be sent to your email, <br /> after you have registered this form.</p>			
			<input name="submit" type="submit" value="' . __( 'Submit', 'wp-members' ) . '" class="buttons" />
		</div>';
			
	// @todo find a better place to put this
	$form = $form . '<div class="reqfield"><font class="req">*</font>' . __( 'Required field', 'wp-members' ) . '			
...
function wpmem_login_form_NEW( $page, $arr ) 
{
	...
	$form.= '[wpmem_txt]<div id="wpmem_login">
		...
		<fieldset>
			<div class="legend login">' . Login/*$arr[0]*/ . '</div>
...
function wpmem_inc_attribution()
{
	...
	*/
	...
	if( WPMEM_OLD_FORMS != 1 && $show_attribution == true ) { // NEW FORMS
		...
		<div class="rocketgeek" align="center">
