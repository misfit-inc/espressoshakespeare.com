...
// Dashboards
 ...
 $mgm_tips_info['pluginmessages']      =__('You will be informed about Magic Members news and updates with this section.','mgm');
 $mgm_tips_info['magicmemberssubscriptionstatus']      =__('All of our customers who bought Magic Members plugin will also get one year free update and full customer support. When your subscription expires, you can extend your account by clicking "Extend" link.','mgm');
 ...
 $mgm_tips_info['versioncheck']      =__('This section will display a notification when Magic Members plugin has a new version. When a new version appears, you will see an "Update" button for you to download lastest version of Magic Members.','mgm');
