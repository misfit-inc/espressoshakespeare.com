...
class mgm_member_custom_fields extends mgm_object{
	...
	// set single
	function set_custom_field($custom_field, $id=false) {		
		// check
	...
	function base_custom_fields() {
		...
		return array( 
				array('id'         => 1,
					  ...
					  'attributes' => array('required'=> false,'readonly'=> true,'hide_label'=> false,)
					  ),
			    ...
			    array('id'         => 3,
		 		...
		 		array('id'         => 5,
			  	...
			  	array('id'         => 6,
					  ...
					  'attributes' => array('required'=> false,'readonly'=> false,'hide_label'=> false)
					  ),
