...
* [Community Examples](http://www.slidedeck.com/jquery-wordpress-web-slider-examples)
* [More Details](http://www.slidedeck.com/wordpress)
* [Full Feature List](http://www.slidedeck.com/web-slider-features)
...
1. Upload the `slidedeck-pro-for-wordpress` folder and all its contents to the `/wp-content/plugins/` directory
...
= 1.3.3 =
* Live version update for 1.3.3

= 1.3.3beta2 =
* BETA Feature: Widget deployment option for users running WordPress 2.8+

= 1.3.3beta1 =
* Added vertical slide autoplay support.
* Updated SlideDeck JavaScript core to version 1.1.8.
* Added ability to choose custom post types as a content source for Smart SlideDecks.
